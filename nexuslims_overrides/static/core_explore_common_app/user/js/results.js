/**
 * NexusLIMS Override: Results pages script for explore keyword app
 *
 * This override modifies the core explore results page functionality with
 * NexusLIMS-specific customizations including:
 * - Hide result pages before populating and use fadeIn() animations for smooth display
 * - Removed highlight.js code highlighting for JSON/XML content
 * - Removed leaveNotice() function calls for external links
 * - Error notification style adjustments
 */
...
var get_data_source_results = function(result_page, data_source_url) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            getDataPermission();
            // NexusLIMS -- removed this section
            ...
            // NexusLIMS: show result_page by fading in
...
openEditRecord = function(id, btnSelector) {
    ...
    $.ajax({
        ...
        error:function(data){
            // NexusLIMS: change style to error rather than danger
