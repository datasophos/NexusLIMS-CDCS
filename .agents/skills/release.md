# NexusLIMS-CDCS Release Workflow

This shared workflow describes how an agent should prepare and run a NexusLIMS-CDCS
release. Claude, Codex, and other repo agents should use this file as the source of
truth for release behavior.

## Invocation Arguments

The release workflow may receive:

- An optional version, such as `3.21.0-nx1`
- Optional flags: `--dry-run` and `--no-push`

Apply these arguments as described in the steps below.
...
1. If the user supplied a version argument (e.g. `3.21.0-nx1`), use it
