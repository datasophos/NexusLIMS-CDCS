            ...
            <xsl:if test="not($simpleDisplay)">
              <div class="sidebar">
                  <table id="nav-table" class="table table-sm table-hover">
                      ...
                      <!--
                      <button id="open-accords-btn" class="btn btn-default" onclick="window.NexusLIMSDetail.openAccords()">
                          <i class="fa fa-plus-square-o"></i> Expand All Panels
                      </button>
                      
                      <button id="close-accords-btn" class="btn btn-default" onclick="window.NexusLIMSDetail.closeAccords()">
            ...
            <div class="main col-sm-12" id="main-column">                        
                    ...
                    <div class="row mt-0" id="simple-display-row">
                        ...
                        <div class="col-sm-9">
                            <div 
                                ...
                                class="alert alert-warning simple-warning mt-3 mb-4">
                                <i
                ...
                <div class="row mt-4">   
                    <button 
                        ...
                        style="position: fixed; width: 125px; left: 40px; padding: 10px;">
                        <i class="fa fa-arrow-up"></i> Scroll to Top
                    </button>
                            ...
                            <code>
                                <a>
                                    ...
                                    <xsl:call-template name="decode">
                                        <xsl:with-param 
                                            name="encoded"
                                            select="substring-after($datasetLink, $filelist-rootpath)"/>
                                    </xsl:call-template>
                                </a>
                            </code>
                        </td>
