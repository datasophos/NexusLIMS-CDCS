"""
Menu configuration for mdcs.

NOTE: Menu configuration has been moved to nexuslims_overrides/menus.py
All menu items below are commented out to prevent duplicates.
See nexuslims_overrides/menus.py for the active menu configuration.
"""
